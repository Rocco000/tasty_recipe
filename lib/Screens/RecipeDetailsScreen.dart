...
class _RecipeDetailsScreenState extends State<RecipeDetailsScreen> {
  ...
  Widget _generateSectionHeader(String sectionTitle, void Function() onPressed) {
    return Padding(
  ...
  List<Widget> _showIngredients(List<RecipeIngredient> recipeIngredientList, List<Ingredient> ingredientList){
    return <Widget>[
      ...
      child: SizedBox(
        ...
        child: Card(
          ...
          child: Column(
            ...
            children: <Widget>[
              const Icon(Icons.warning_amber_rounded, size: 48, color: Color(0xFFE63946),),
              Text(
                msg,
                style: const TextStyle(
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          child: FutureBuilder<(Recipe, List<RecipeIngredient>, List<Ingredient>, List<RecipeStep>)>(
            future: widget._controller.loadFullRecipe(widget._recipeId),
            builder: (context, snapshot){
              ...
              if (!snapshot.hasData){
                ...
                return _generateErrorMessage("Something went wrong. Try again.");
              }
          
              // Show data when data is ready
              final (recipe, recipeIngredientList, ingredientList, stepList) = snapshot.data!;
              return Column(
                children: <Widget>[
                  // RECIPE GENERAL INFO
                  ..._showRecipeGeneralInfo(recipe),
