...
class ProfileScreen extends StatefulWidget {
  final String route = "/profileScreen";
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget _generateProfileRecipeInfo(int index){
    ...
    return Chip(
      avatar: Recipe.getMealIcon(category),
      backgroundColor: Colors.orange.shade300,
      label: Text("$category: $count", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),),
    );
            ...
            child: Column(
              children: <Widget>[
                      ...
                      children: <Widget>[
                        ...
                        Positioned(
                          ...
                          child: CircleAvatar(
                            ...
                            child: CircleAvatar(
                              radius: 46,
                              backgroundImage: AssetImage("content/images/dessertBackground.jpg"),
                            ),
                          )
                        ),
                ...
                Padding(
                  ...
                  child: Text("${_user.username}", style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
                ),
                ...
                Padding(
                  ...
                  child: Wrap(
                    spacing: 2.0,
                    runSpacing: 2.0,
                    children: List.generate(5, (index) => _generateProfileRecipeInfo(index)),
                  ),
                ),
